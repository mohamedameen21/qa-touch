    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex justify-center m-5">
                <SecondaryButton @click="signInWithGoogle" class="text-2xl"><img width="35" src="/images/google-logo.svg" alt="google logo" class="mr-2" /> Sign Up With Google</SecondaryButton>
            </div>
